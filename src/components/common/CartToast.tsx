...
export function CartToast() {
  const { toast, hideToast, openCart } = useCartContext();
  ...
  return (
    <div className="fixed top-6 right-4 sm:right-6 z-[60] max-w-sm w-full animate-slide-left pointer-events-auto">
      <div className="relative overflow-hidden rounded-2xl bg-[#0d1527]/95 dark:bg-[#0d1527]/95 text-white p-3.5 shadow-2xl border border-emerald-500/30 backdrop-blur-xl flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs font-bold text-slate-100 truncate max-w-[160px] sm:max-w-[180px]">
              {toast.itemTitle}
            </p>
          </div>
        </div>
