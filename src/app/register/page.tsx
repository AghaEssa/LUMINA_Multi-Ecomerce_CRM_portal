    ...
    <div className="relative w-full max-w-[440px] overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/90 p-6 sm:p-9 text-slate-900 dark:text-white shadow-2xl backdrop-blur-xl z-10 transition-all duration-300">
      ...
      <div className="text-center pt-1">
        ...
        <h1 className="text-xl sm:text-2xl font-black tracking-tight text-slate-900 dark:text-white mt-5 mb-2">
          {is2FASetupStep ? "Scan & Verify 2FA" : "Create Lumina Account"}
        </h1>
        <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-6">
          {is2FASetupStep ? "Scan QR with Google Authenticator" : "Join Lumina for instant checkout & order tracking"}
        </p>
      </div>

      {/* 2FA Success Banner */}
      {setupSuccess && (
        <div className="mb-5 rounded-2xl bg-emerald-50 dark:bg-emerald-500/20 border border-emerald-200 p-3.5 text-xs text-emerald-800 dark:text-emerald-200 flex items-center gap-2.5 shadow-xs">
      ...
      {is2FASetupStep ? (
        <div className="space-y-4 animate-fade-in">
          {qrCodeUrl && (
            <div className="flex flex-col items-center justify-center p-3.5 rounded-2xl bg-white border border-slate-200 shadow-sm">
          ...
          <form onSubmit={handleVerify2FASetup} className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-[#075570] hover:bg-[#053d52] dark:bg-amber-400 dark:hover:bg-amber-500 text-white dark:text-slate-950 font-black text-sm py-3.5 shadow-md active:scale-[0.99] transition disabled:opacity-50 cursor-pointer"
            >
        ...
        <div className="relative z-10 max-w-xl space-y-8 my-auto py-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-ocean-100/90 leading-relaxed font-normal">
              Create your account to unlock guest-to-account cart synchronization, saved wishlists, express 2FA checkout, and order history.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-3.5 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md space-y-1">
              ...
              <p className="text-[10px] text-ocean-200">Google Authenticator ready</p>
            </div>
            <div className="p-3.5 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md space-y-1">
